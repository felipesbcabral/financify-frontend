...
function InitialPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="bg-white rounded-lg overflow-hidden shadow-lg border border-gray-300 max-w-screen-md">
        <div className="py-8 px-4 mx-auto sm:py-16 lg:px-6">
          <div className="text-center">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold leading-tight text-black">
            ...
            <ul className="list-disc mb-6 text-black list-inside inline-block">
