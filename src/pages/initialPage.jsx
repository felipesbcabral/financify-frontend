...
import '../Styles/initialPage.css'; // Importação do arquivo CSS
...
function InitialPage() {
  ...
  return (
    <div className="home-container">
      ...
      <p>O Financify é seu aplicativo para controle financeiro pessoal, ajudando você a gerenciar suas finanças de forma eficaz.</p>
