        ...
        <div className="row">
          <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
            ...
            <div className="flex flex-col">
              <button
                className="bg-green-400 px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg mb-4"
                onClick={handleGoBack}
              >
                Vá para a página inicial
              </button>
              <button
                className="bg-blue-400 px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg"
                onClick={handleLogin}
              >
                Vá para o login
              </button>
